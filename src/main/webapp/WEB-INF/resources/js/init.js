...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'resources/css/style.css', containers: 1400, grid: { gutters: 48 } },
			'wide':		{ range: '-1680', href: 'resources/css/style-wide.css', containers: 1200 },
			'normal':	{ range: '-1280', href: 'resources/css/style-normal.css', containers: '100%', grid: { gutters: 36 } },
			'narrow':	{ range: '-960', href: 'resources/css/style-narrow.css', grid: { gutters: 32 } },
			'narrower': { range: '-840', href: 'resources/css/style-narrower.css', containers: '100%!', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: 'resources/css/style-mobile.css', grid: { gutters: 20 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
